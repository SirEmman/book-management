...
public class BookRepository {
    ...
    public Book createBook(Book book) {
        ...
        Book b = Book.builder()
                .isbn((book.getIsbn() != null && !book.getIsbn().isBlank()) ? book.getIsbn() : generateIsbn())
                .title(book.getTitle())
    ...
    public List<Book> ListeBooksByCategory(String categoryName) {
        return em
                .createQuery("SELECT b FROM Book b WHERE LOWER(b.category.name) = LOWER(:categoryName) ORDER BY b.title", Book.class)
    ...
    public Map<String, Long> countBooksByCategory() {
        List<Object[]> results = em
                .createQuery("SELECT c.name, COUNT(b) FROM Book b JOIN b.category c GROUP BY c.name ORDER BY c.name", Object[].class)
                .getResultList();
